...
class SemestersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create semester" do
    assert_difference('Semester.count') do
      post semesters_url, params: { semester: { semester_number: @semester.semester_number, student_id: @semester.student_id } }
    end
  ...
  test "should update semester" do
    patch semester_url(@semester), params: { semester: { semester_number: @semester.semester_number, student_id: @semester.student_id } }
